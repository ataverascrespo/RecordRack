    ...
    return (
        <section id="about-page" className="container">
            <div className="lg:h-[100vh] z-0 mt-48 lg:mt-0 flex flex-col justify-end lg:flex-row lg:justify-between items-center gap-8 lg:gap-16" >
                ...
                <div className="flex flex-col mt-0 lg:mt-48 self-start items-start gap-2 ">
                    ...
                    <p className="max-w-3xl text-xl lg:text-2xl font-semibold mx-auto tracking-tight">
                        Share your favorite finds, discover new gems, and celebrate the universal language of music together.
                    </p>
            ...
            <div className="lg:h-[50vh] z-0 mt-48 xl:mt-0 flex flex-col justify-end lg:flex-row lg:justify-between items-center gap-8 lg:gap-16">
                ...
                <Accordion type="single" collapsible className="w-full lg:w-[45%]">
                    ...
                    <AccordionItem value="item-4">
                        <AccordionTrigger>How does Record Rack protect my personal information?
                        </AccordionTrigger>
                        <AccordionContent>
                            Record Rack does not collect any of your personal data, apart from what you provide during account creation. From the ground up, I’ve used industry-standard and advanced encryption methods to protect that information!
            ...
            <div className="lg:h-[50vh] z-0 mt-24 mb-24 xl:mt-0 flex flex-col lg:flex-row lg:justify-between items-center">
                <Card className="w-full lg:w-2/3">
                    ...
                    <CardContent>
                        <p className="max-w-3xl text-base xl:text-xl tracking-tight">
                    ...
                    <CardFooter className="w-full flex justify-center gap-4">
                        <Button>
                            <div className="flex flex-row gap-2 items-center">
                                <p className="hidden md:inline">Email Me</p>
                        ...
                        <Button>
                            <div className="flex flex-row gap-2 items-center">
                                <p className="hidden md:inline">Donate</p>
