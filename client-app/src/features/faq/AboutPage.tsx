        ...
        <section id="about-page" className="container">
            ...
            <div className="z-0 mt-24 mb-24 lg:mt-48 lg:mb-48 flex flex-col justify-start lg:flex-row lg:justify-between items-center gap-8 lg:gap-16">
                ...
                <Accordion type="single" collapsible className="w-full lg:w-[45%]">
                    <AccordionItem value="item-1">
                        <AccordionTrigger>
                            <p className="text-left">Is there a Record Rack mobile app I can download?</p>
                        </AccordionTrigger>
                        <AccordionContent>
                            There is no traditional Record Rack app, but this site is actually a <strong>progressive web app, or a PWA for short.</strong> Being a PWA means Record Rack can be installed on your devices (including phones, tablets and computers!) and used offline or on the go, like a regular app. <a href="https://mobilesyrup.com/2020/05/24/how-install-progressive-web-app-pwa-android-ios-pc-mac/" className="font-bold underline">Here's the instructions on how you can do that for different devices.</a>
                        </AccordionContent>
                    </AccordionItem>
            ...
            <div className="z-0 mt-24 mb-24 lg:mt-48 lg:mb-48 flex flex-col lg:flex-row lg:justify-between items-center">
                <Card className="w-full lg:w-2/3">
                    <CardHeader>
                        <CardTitle className="leading-normal"> Record Rack is completely free to use, with absolutely no ads.</CardTitle>
                    </CardHeader>
                    <CardContent>
                    ...
                    <CardFooter className="w-full flex justify-start gap-4">
                        <Link className="w-1/3" to={"mailto:alexmanuelt@hotmail.com?subject=Record%20Rack%20Feedback%20"}>
                            <Button className="w-full">
                                <div className="flex flex-row gap-2 items-center">
                                    <p className="hidden sm:inline"> Email Me  </p>
                        ...
                        <Link className="w-1/3" to={"https://github.com/ataverascrespo/RecordRack"}>
                            <Button className="w-full">
                                <div className="flex flex-row gap-2 items-center">
                        ...
                        <Link className="w-1/3" to={"https://www.buymeacoffee.com/ataverascrespo"}>
                            <Button className="w-full">
                                <div className="flex flex-row gap-2 items-center">
