            ...
            <div className="h-full container z-10 mt-48 lg:mt-0 flex flex-col justify-start lg:flex-row lg:justify-between items-center ">
                <div className="flex flex-col items-start lg:justify-center text-left ">
                    <div className="w-full h-full mb-16">
                        ...
                        {/* Dark hero text */}
                        <img className="w-full hidden dark:block" src={"/assets/logo-darkmode.svg"} draggable="false" alt="logo" />
                        {/* Light hero text  */}
                        <img className="w-full block dark:hidden" src="/assets/logo-lightmode.svg" draggable="false" alt="logo" />
                        {/* Subheader */}
