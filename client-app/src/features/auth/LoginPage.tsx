            ...
            <div className="h-full mt-48 mb-24 flex flex-col justify-center gap-8 items-center ">
                ...
                <Card className="h-full w-full md:w-2/3 lg:w-1/2 xl:w-1/3 p-2 pt-6">
                    ...
                    <CardContent className="grid gap-4">
                        <LoginForm></LoginForm>
                        <div className="flex">
                            <Link className="text-center font-semibold text-sm hover:underline" to={"/forgot-password"}>
                    ...
                    <CardFooter>
                        <div className="flex flex-col w-full items-center">
                            ...
                            <p className="mt-4 text-base text-center">Don't have an account?&nbsp;
                                <Link className="text-base font-bold hover:underline" to={"/register"}> Register&nbsp;</Link>
                            </p>
                        </div>
