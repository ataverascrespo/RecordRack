            ...
            <div className="container">
                <div className="h-full mt-48 mb-24 flex flex-col justify-center gap-8 items-center ">
                    ...
                    <div className="flex flex-col gap-8 items-center text-neutral-800 dark:text-neutral-50">
                        ...
                        <img className="mt-8 w-full md:w-2/3 lg:w-1/2" src="/assets/not-verified.svg" alt="verification failed" draggable="false" />
                    </div>
                </div>
            </div>
        )
            ...
            <div className="container">
                <div className="h-full mt-48 mb-24 flex flex-col justify-center gap-8 items-center ">
                    ...
                    <div className="flex flex-col gap-8 items-center text-neutral-800 dark:text-neutral-50">
                        ...
                        <img className="mt-8 w-full md:w-2/3 lg:w-1/2" src="/assets/verified.svg" alt="verification sent" draggable="false" />
                    </div>
                </div>
            </div>
        )
