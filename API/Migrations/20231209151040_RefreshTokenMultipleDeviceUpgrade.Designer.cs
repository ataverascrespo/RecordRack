...
namespace AlbumAPI.API.Migrations
{
    ...
    [Migration("20231209151040_RefreshTokenMultipleDeviceUpgrade")]
    partial class RefreshTokenMultipleDeviceUpgrade
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AlbumAPI.Models.UserFollowing", b =>
                {
            ...
            modelBuilder.Entity("AlbumAPI.Models.UserFollowing", b =>
                {
                    b.HasOne("AlbumAPI.Models.User", "Follower")
                        .WithMany("Followings")
                        .HasForeignKey("FollowerID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AlbumAPI.Models.User", "Target")
                        .WithMany("Followers")
